...
const videos = [
  {
    ...
    file: 'cyber-city-lesson6-overview.mp4',
    accent: '#0f766e',
    icon: '06',
    visual: 'בודקים אתר לפני שמכניסים פרטים',
    bullets: ['אתר הוא גם כתובת וגם תוכן', 'רואים HTML מאחורי המסך', 'Python מחפש סימני סיכון בדף'],
    code: ['page = input("page text: ")', 'if "password" in page:', '    risk += 30'],
    script: [
      '[warm] בשיעור 6 אנחנו נכנסים ל־Website Detective.',
      '[clear] אתר הוא לא רק מה שרואים על המסך. יש לו כתובת, טקסט, טופס וכפתורים.',
      '[practical] נעבוד בסביבת אימון סגורה, נחקור HTML אמיתי, ונבנה Website Security Checker עם Python.',
    ],
  },
  {
    id: 'brief',
    title: 'פתיחה',
    file: 'cyber-city-lesson6-brief.mp4',
    accent: '#2563eb',
    icon: '01',
    visual: 'שני דפים יכולים להיראות דומים',
    bullets: ['בודקים לפני שמקלידים', 'לא מכניסים פרטים באתר חשוד', 'מסתכלים על כתובת ועל תוכן'],
    code: ['controlled cyber lab', 'inspect page text', 'security action'],
    script: [
      '[warm] בשלב הפתיחה אנחנו מבינים את המשימה.',
      '[clear] שני אתרים יכולים להיראות דומים, אבל הכתובת והטקסט שלהם יכולים לספר סיפור אחר.',
      '[practical] היום עובדים בסביבת סייבר סגורה בתוך הלומדה, כדי לתרגל כמו חוקרים בלי לסכן אתרים אמיתיים.',
    ],
  },
  {
    id: 'anatomy',
    title: 'ממה אתר מורכב',
    file: 'cyber-city-lesson6-anatomy.mp4',
    accent: '#0891b2',
    icon: '02',
    visual: 'כתובת, כותרת, טופס וכפתור',
    bullets: ['בודקים את הכתובת', 'מזהים טופס התחברות', 'שמים לב לכפתור שמבקש פעולה'],
    code: ['url', 'title', 'button'],
    script: [
      '[friendly] בשלב הזה מפרקים אתר חשוד לרכיבים שחוקר סייבר בודק.',
      '[clear] מסתכלים על הכתובת, הכותרת, השדות בטופס, והכפתור שמבקש מאיתנו לעשות משהו.',
      '[practical] כל חלק כזה יכול להיות סימן שעוזר להחליט אם להמשיך או לעצור.',
    ],
  },
  {
    id: 'html',
    title: 'HTML ראשון',
    file: 'cyber-city-lesson6-html.mp4',
    accent: '#7c3aed',
    icon: '03',
    visual: 'מאחורי הדף יש תגיות וטקסט',
    bullets: ['רואים h1, input ו-button', 'לא לומדים HTML עמוק', 'מבינים מה הדף מבקש'],
    code: ['<h1>Login</h1>', '<input>', '<button>Verify</button>'],
    script: [
      '[focused] עכשיו מסתכלים רגע מאחורי המסך.',
      '[clear] HTML הוא טקסט שמסביר לדפדפן מה להציג: כותרת, שדה, כפתור ועוד.',
      '[practical] אנחנו לא הופכים את זה לקורס בניית אתרים. לומדים לקרוא סימני התחזות בתוך דף אתר.',
    ],
  },
  {
    id: 'python',
    title: 'Python בודק דף',
    file: 'cyber-city-lesson6-python.mp4',
    accent: '#16a34a',
    icon: 'if',
    visual: 'if ו-in מחפשים מילים בדף',
    bullets: ['מכניסים טקסט מדף אתר', 'לוחצים על ▶ הרצה', 'רואים אילו סימני סיכון נמצאו'],
    code: ['if "password" in page:', '    risk += 30', 'print("Risk:", risk)'],
    script: [
      '[curious] עכשיו Python בודק את הטקסט של דף האתר.',
      '[clear] אם המילה password נמצאת בדף, ה־Risk עולה. אם free או verify נמצאות, גם הן יכולות להוסיף סיכון.',
      '[practical] זה אותו רעיון מוכר: כמה תנאי if קצרים, בלי לולאות ובלי רשימות.',
    ],
  },
  {
    id: 'cases',
    title: 'הרצת אתרי אימון',
    file: 'cyber-city-lesson6-cases.mp4',
    accent: '#f59e0b',
    icon: '▶',
    visual: 'בודקים כמה אתרי אימון',
    bullets: ['בוחרים אתר חשוד', 'רואים אילו תנאים הופעלו', 'מחליטים אם לעצור או לבדוק עוד'],
    code: ['Risk: 75', 'found: password', 'action: stop and check'],
    script: [
      '[encouraging] עכשיו מריצים את הכלי על כמה אתרי אימון.',
      '[clear] דף אחד יכול להיות רגיל, דף אחר יכול לבקש סיסמה בשביל פרס חינם, ודף שלישי יכול להיראות כמו התחזות.',
      '[practical] המטרה היא להבין למה ה־Risk יצא ככה, ולא להכניס פרטים לפני בדיקה.',
    ],
  },
  {
    id: 'report',
    title: 'דוח סיום',
    file: 'cyber-city-lesson6-report.mp4',
    accent: '#0f766e',
    icon: '✓',
    visual: 'מסבירים את בדיקת האתר',
    bullets: ['מה ראיתי בדף האתר', 'אילו סימני סיכון מצאתי', 'מה הפעולה הבטוחה'],
    code: ['checked: page text', 'risk: high', 'action: do not type details'],
    script: [
      '[warm] בשלב האחרון מסכמים כמו חוקרי סייבר.',
      '[clear] כותבים מה ראינו בדף האתר, אילו סימני סיכון מצאנו, ומה עושים לפני שמכניסים פרטים.',
      '[closing] התוצר של השיעור הוא Website Safety Checker קצר, והבנה ראשונה של HTML ושל בדיקת דף עם Python.',
    ],
  },
];
...
Style: professional cyber language, confident, investigative, classroom instruction. Avoid words that sound childish or watered down. Read only the Hebrew lines. Do not read bracket labels.

${video.script.join('\n')}`;
}

async function createGeminiAudio(video) {
  const base = path.join(MARKETING, `cyber-city-lesson6-${video.id}-leda`);
...
<body>
<div id="stage">
  <div class="brand"><span class="pill">Cyber AI Builders</span><span class="pill light">שיעור 6</span></div>
...
async function renderVideo(browser, video) {
  ...
  const outDir = path.join(MARKETING, `cyber-city-lesson6-${video.id}-frames`);
  const silentPath = path.join(MARKETING, `cyber-city-lesson6-${video.id}-silent.mp4`);
