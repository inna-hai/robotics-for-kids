...
assert.ok(html.includes('20260919-linux-basics-v3'), 'lesson 7 cache key should include the Linux basics version');
...
assert.ok(css.includes('.command-card-video'), 'command concept cards should style the new short animations');
