...
try {
  ...
  assert.deepEqual(
    ...
    ['classroom-courses-backfill-v1', 'kugel-class-sessions-lesson-range-v1', 'kugel-student-runs-lesson-range-v1', 'minecraft-player-nocase-index-v1', 'student-login-usernames-v1', 'teacher-courses-backfill-v1'],
  );
