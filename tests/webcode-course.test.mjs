...
assert.ok(play.includes('blocklyXml') && play.includes('workspaceToDom') && play.includes('domToWorkspace(parseBlocklyXml(saved.blocklyXml'), 'real Blockly workspace persists across page refreshes');
