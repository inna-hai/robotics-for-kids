...
test('homepage is now a platform gateway and links to primary learning modules', () => {
  ...
  assertIncludes(homepageHtml, '<a class="btn cta-free" href="register.html">נסו 3 שיעורי סיסי בחינם</a><a class="btn" href="summer-subscription.html">עמוד מנוי קיץ</a>');
