...
assert.ok(missions.flatMap(mission => mission.challenges).every(challenge => challenge.title && challenge.prompt && challenge.starterCode && challenge.hint && challenge.checker), 'every challenge should be runnable and checkable');
