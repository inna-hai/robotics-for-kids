...
assert.ok(playHtml.includes('Snack and water station') && playHtml.includes('תחנת חטיפים ומים'), 'lesson 13 task 3 should be a more interesting snack and water station');
assert.ok(playHtml.includes('תחנת חטיפים ומים צריכה חיה'), 'lesson 13 task 3 feedback should match the snack and water station');
...
assert.ok(playHtml.includes('כיסא לחיה') && playHtml.includes('גדר קדמית') && playHtml.includes('תחנת חטיפים ומים') && playHtml.includes('בית גדול לחיות'), 'lesson 13 should include compact models for tasks 1-4');
