(function () {
  ...
  const LESSON_WORLDS = {
    0: {
      id: 'kugel-50-safe-compounds-v3-mazes-8-coins-npc-reset-caged-inner-wood-obstacle-test-v1-20260906',
      name: 'Kugel 50 Safe Compounds v3 - Maze Wood Obstacle Test',
      mode: 'Adventure',
