...
const lessons = [
  ...
  },
  {
    ...
    color: '#7c3aed',
    slides: [
      ['פתיחה', 'איך גורמים לנו לקנות?', 'האם קניתם פעם משהו שלא תכננתם לקנות?', 'שאלה לכיתה: מה השפיע — מחיר, חברים, פרסומת, משפיען, לחץ זמן או משלוח חינם?'],
      ['מטרת המפגש', 'לא נגד קניות — בעד בחירה מודעת', 'המטרה היא לזהות מה דוחף אותנו, לחשב מחיר אמיתי, ולבחור לפי מטרה ולא לפי לחץ רגעי.', 'מסר למדריך: לא מביישים קניות ולא מבקשים לחשוף מצב אישי. עובדים דרך דמויות.'],
      ['מה משפיע על קנייה?', 'החלטה לא נוצרת בחלל ריק', 'פרסומות, משפיענים, חברים, לחץ זמן, מבצעים, FOMO, נוחות תשלום ועיצוב המסך.', 'פעולה: התלמידים מצביעים על גורם אחד שהם מזהים באפליקציות.'],
      ['צורך, רצון חשוב ורצון רגעי', 'אותו מוצר, הקשר אחר', 'נעליים יכולות להיות צורך, מתנה יכולה להיות רצון חשוב, וסקין מוגבל יכול להיות רצון רגעי שמופעל מלחץ.', 'דגש: לא תמיד יש תשובה אחת; מבקשים נימוק.'],
      ['FOMO', 'הפחד להחמיץ', 'תחושה שאם לא נפעל עכשיו נפסיד מוצר, אירוע, מחיר או שייכות חברתית.', 'דוגמאות: “נותרו 2”, “רק היום”, “כולם כבר קנו”, סקין במהדורה מוגבלת.'],
      ['האם מבצע באמת חוסך?', 'הנחה אינה תמיד חיסכון', 'אם לא תכננתי לקנות, ייתכן שלא חסכתי כסף — אלא הוצאתי כסף שלא היה בתוכנית.', 'שאלה: מתי מבצע כן יכול להיות החלטה טובה?'],
      ['המחיר האמיתי', 'לא רק המחיר שעל הכפתור', 'בודקים מחיר מוצר, משלוח, תוספות, מנוי חודשי, חידוש אוטומטי, עלות שנתית ועלות אלטרנטיבית.', 'פעולה: מפרקים יחד מוצר של 130 ש״ח עם משלוח ומנוי.'],
      ['מטבעות וירטואליים', 'כסף שמרגיש פחות אמיתי', '1,000 מטבעות עולים 40 ש״ח; פריט של 750 מטבעות הוא בערך 30 ש״ח, אבל נשאר עודף שמושך לקנייה נוספת.', 'שאלה: למה משחקים משתמשים במטבע ולא תמיד בשקלים?'],
      ['דפוסים מניפולטיביים', 'עיצוב שדוחף החלטה', 'טיימר, מחסור מדומה, כפתור ביטול מוסתר, תיבה מסומנת מראש, “משלוח חינם מעל...” וקושי לבטל מנוי.', 'בלומדה: התלמידים לוחצים על אזורים במסך קנייה מדומה וחושפים את הטריקים.'],
      ['משפיענים ופרסום', 'אמון אינו בדיקה', 'בודקים האם התוכן ממומן, האם מוצגים חסרונות, האם המוצר מתאים לי והאם אני קונה בגלל האדם או בגלל המוצר.', 'דגש: לא לתקוף משפיענים; ללמד שאלות בדיקה.'],
      ['עצור–בדוק–בחר', 'כלי החלטה קצר', 'עצור: מזהים לחץ. בדוק: עלות כוללת, חלופה, מטרה, מנוי ותנאים. בחר: קונים, מחכים, מחפשים חלופה או מוותרים.', 'פעולה: כל תלמיד מנסח כלל המתנה שמתאים לדמות.'],
      ['עצירת מדריך', 'דיון כיתתי לפני משימת הדמות', 'האם “50% הנחה” חוסך אם לא תכננתי לקנות? מתי רצון הוא חשוב? כמה זמן כדאי לחכות לפני קנייה דחופה?', 'הנחיה: לבקש דוגמאות דרך דמויות ולא דרך חשיפת נתונים אישיים.'],
      ['מעבר ללומדה', 'חושפים, מסווגים ומחשבים', 'זהו טריקים שיווקיים, סווגו צורך/רצון, חשבו עלות אמיתית וקבלו החלטה מנומקת עבור דמות.', 'הנחיה: תוצר טוב כולל בדיקות ונימוק, לא רק תשובה “לקנות/לא לקנות”.'],
      ['סיכום', 'קנייה חכמה היא קנייה מודעת', 'מבצע אינו הופך קנייה לכדאית. המחיר האמיתי כולל עלויות נסתרות. עצירה קצרה מונעת החלטות אימפולסיביות.', 'שאלת יציאה: איזה כלל קנייה תאמצו לפני קנייה דיגיטלית או מבצע?']
    ]
  },
  {
    id: 3,
