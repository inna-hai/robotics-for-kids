  ...
  const challenges = [
    ...
    },
    {
      ...
      checks: [
        ...
        'יש שימוש ברעיונות שנלמדו: רצף, לולאה, משתנה או if.',
    ...
    4: [
      {
        ...
        exit: 'איזו אוטומציה כבר קיימת בעיר, ואיזו אוטומציה חדשה אתם מוסיפים?'
      },
      {
        goal: 'להוסיף אוטומציה חדשה אחת לעיר ולוודא שהיא עושה שינוי ברור בעולם.',
        teacher: ['מדגישים: קודם אוטומציה אחת שעובדת, אחר כך מחברים עוד.', 'מבקשים ש-start יפעיל פעולה שרואים בעולם.', 'בודקים שהאוטומציה החדשה לא שוברת את הקו הקיים.'],
        build: ['מערכת חדשה או שדרוג למערכת קיימת.', 'שלט שם למערכת.', 'סימון המקום שבו האוטומציה מתחילה ופועלת.'],
