(function () {
  ...
  // HYBRID_MODEL_GRADE6_LESSONS_6_10_START

  Object.assign(window.TELLO_MISSION_LAB_LESSONS[5], {
    title: 'שיעור 6: סריקת קו חוף — מסלול חקר ליניארי',
    subtitle: 'מסלול הלוך-חזור, ריחוף לאיסוף נתונים ותיעוד נקודות עניין',
    concept: 'סריקה ליניארית, Hover for Data, חזרה בטוחה וניהול סוללה',
    story: 'צוות Mission Lab נקרא לסרוק קו חוף קצר אחרי סערה. אין צורך במסלול מורכב: צריך לטוס בקו מדויק, לעצור בנקודת תצפית, לאסוף נתון ולחזור לנחיתה בטוחה.',
    mission: 'לבנות משימת Coastline Scan: Safety Check → Takeoff → Forward → Hover for Data → Back → Land, להריץ בסימולטור ולבצע חלק פיזי קצר רק באישור מדריך.',
    blocks: ['safety_check', 'takeoff', 'forward', 'hover_data', 'back', 'land'],
    essentialQuestion: 'איך מתכננים סריקה קצרה שאוספת מידע בלי לבזבז סוללה או לצאת מהאזור?',
    successCriteria: ['אני מתכנן/ת מסלול הלוך-חזור קצר וברור.', 'אני משתמש/ת בריחוף כנקודת איסוף נתונים.', 'אני מסביר/ה למה חזרה בטוחה חשובה כמו הגעה ליעד.', 'אני מתעד/ת נקודת עניין אחת.', 'אני שומר/ת על גבולות טיסה פיזית קצרה.'],
    realWorldUses: [
      { icon:'🌊', title:'סריקת חוף', text:'רחפן יכול לבדוק קו חוף אחרי סערה בלי לסכן אדם.' },
      { icon:'🔋', title:'ניהול סוללה', text:'מסלול קצר מאפשר לחזור לפני סוללה חלשה.' },
      { icon:'📍', title:'נקודת עניין', text:'עצירה מדויקת מאפשרת תיעוד במקום הנכון.' }
    ],
    vocabulary: [
      ['Linear Scan','סריקה בקו אחד קדימה וחזרה.'],
      ['Point of Interest','נקודת עניין לתצפית.'],
      ['Hover for Data','ריחוף קצר לאיסוף מידע.'],
      ['Return Path','חזרה במסלול בטוח.'],
      ['Battery Budget','תכנון משימה לפי מגבלת סוללה.']
    ],
    safetyRules: ['טיסה פיזית רק באישור מדריך ובתור מוגדר.', 'משקפי מגן ואזור סטרילי בכל הפעלה פיזית.', 'כל משימה מתחילה בבדיקת סוללה, מדחפים ומרחב.', 'אם יש סטייה או אדם נכנס לאזור — Abort/Land מיד.', 'שומרים גרסת סימולטור לפני שינוי פיזי.'],
    commonDirections: [['Forward', 'יציאה לנקודת סריקה.'], ['Hover Data', 'עצירה לתיעוד.'], ['Back', 'חזרה לאזור נחיתה.'], ['Battery', 'גבול זמן המשימה.'], ['Land', 'סיום בטוח.']],
    setupSteps: ['פותחים את גרסת השיעור הקודם ובודקים מה נשמר.', 'מריצים קודם בסימולטור.', 'מגדירים תפקידים: Driver, Navigator, Observer/Data Recorder.', 'בודקים אזור וסוללה אם יש הרצה פיזית.', 'שומרים בשם ברור ומשתפים/מצלמים תוצר.'],
    tabletTips: ['לשמור ב־WiFi בית ספרי לפני מעבר ל־Tello WiFi.', 'לא לשנות כמה פרמטרים יחד.', 'לצלם מסך אם Share Link לא זמין.', 'לחזור ל־WiFi בית ספרי אחרי טיסה פיזית לתיעוד.', 'לסגור אפליקציות מיותרות לפני סימולטור.'],
    lessonFlow: [
      { minutes:'0–8', title:'גשר משיעור 5', teacher:'מחזיר להבדלי סימולטור/מציאות ולצורך במסלול קצר.', students:'פותחים תיעוד שיעור 5.' },
      { minutes:'8–18', title:'עלילת קו החוף', teacher:'מציג אזור סריקה ליניארי ונקודת עניין.', students:'מסמנים Start/POI/Land.' },
      { minutes:'18–30', title:'תכנון סוללה', teacher:'מסביר למה לא טסים רחוק מדי בטיסה ראשונה אחרי System Check.', students:'מגדירים Battery Budget פשוט.' },
      { minutes:'30–46', title:'בניית סימולטור', teacher:'מדגים Forward/Hover Data/Back.', students:'בונים ומריצים.' },
      { minutes:'46–62', title:'בדיקה פיזית חלקית', teacher:'מאשר רק מסלול קצר ובטוח.', students:'מבצעים או צופים לפי תור.' },
      { minutes:'62–76', title:'תיעוד נקודת עניין', teacher:'מנחה תיעוד: מה ראינו ומה היינו מצלמים.', students:'כותבים תיעוד חקר.' },
      { minutes:'76–86', title:'דיבוג סטייה', teacher:'שואל מה עושים אם הרחפן לא חוזר בדיוק.', students:'מציעים תיקון אחד.' },
      { minutes:'86–90', title:'סיכום', teacher:'מחבר לשיעור 7: כיסוי שטח שיטתי.', students:'כרטיס יציאה.' }
    ],
    exercises: [
      { minutes:'8–18', title:'מפת קו חוף', prompt:'שרטטו Start, POI ו־Land.', check:'יש שלוש נקודות.' },
      { minutes:'30–46', title:'Coastline Scan', prompt:'בנו והריצו רצף הלוך-חזור.', check:'הרצף מתחיל ונגמר בטוח.' },
      { minutes:'46–62', title:'בדיקה מבוקרת', prompt:'הריצו פיזית רק אם אושר.', check:'ההרצה קצרה.' },
      { minutes:'62–76', title:'תיעוד POI', prompt:'כתבו מה נאסף בנקודת העניין.', check:'יש תיאור נקודה.' },
      { minutes:'76–86', title:'תיקון אחד', prompt:'בחרו תיקון אחד לסטייה.', check:'לא משנים כמה דברים.' },
      { minutes:'86–90', title:'כרטיס יציאה', prompt:'מסלול חקר טוב חוזר כי...', check:'מזכיר בטיחות/סוללה.' }
    ],
    deliverable: 'Coastline_Scan_G6: מסלול הלוך-חזור מתועד + נקודת עניין אחת.',
    assessment: ['יש מסלול קצר וברור.', 'ריחוף הנתונים ממוקם אחרי Forward.', 'יש חזרה ונחיתה.', 'התיעוד קשור לנקודת עניין.', 'הצוות שומר על מגבלות פיזיות.'],
    debugging: [
      { problem:'המסלול ארוך מדי', fix:'מקצרים Forward ומשמרים נקודת עניין אחת.' },
      { problem:'אין חזרה בטוחה', fix:'מוסיפים Back לפני Land.' },
      { problem:'הצוות משנה כמה דברים', fix:'חוזרים לשינוי אחד.' },
      { problem:'הרצה פיזית לא מאושרת', fix:'מסתפקים בסימולטור ותיעוד.' }
    ],
    differentiation: { support: ['לתת תבנית מפה פשוטה.', 'לאפשר צפייה במקום הפעלה פיזית.', 'להשתמש בערכי מרחק מוכנים.'], extension: ['להוסיף נקודת עניין שנייה בסימולטור בלבד.', 'להציע מדד סוללה משוער.', 'להשוות הלוך-חזור מול נחיתה בנקודת יעד.'] },
    instructorGuide: { prerequisites: 'נדרש System Check פיזי משיעור 5 או החלטה לעבוד בסימולטור בלבד אם אין מוכנות פיזית.', pedagogy: ['המעבר אחרי שיעור 5 צריך להישאר צנוע ומבוקר.', 'הדגש הוא חקר ותיעוד, לא “טיסה ארוכה”.', 'ריחוף הוא פעולה מחקרית: זמן להסתכל ולתעד.'], mediaNote: commonInstructorMediaNote, exitTicket: 'חזרה בטוחה חשובה כי ___.' },
    videoResources: grade6VideoResources,
    screenshotSlides: [
      { title:'פותחים משימת חקר', src:'assets/tello-mission-lab/lesson6/open-app.png', caption:'מתחילים מגרסת סימולטור ושם משימה ברור.' },
      { title:'רצף בלוקים', src:'assets/tello-mission-lab/lesson6/block-sequence.png', caption:'בודקים שהרצף מתאים למטרת החקר.' },
      { title:'הרצה ובדיקה', src:'assets/tello-mission-lab/lesson6/simulator-run.png', caption:'מריצים, מודדים ומתעדים תוצאה.' },
      { title:'שמירה ושיתוף', src:'assets/tello-mission-lab/lesson6/save-share.png', caption:'שומרים תוצר ותיעוד למדריך.' }
    ],
    instructorSlides: [
      { title:'סריקה ליניארית', body:'משימה קצרה וברורה לאיסוף מידע.', bullets:['Start', 'POI', 'Return'] },
      { title:'ריחוף כנתון', body:'Hover אינו עצירה ריקה — הוא זמן תצפית.', bullets:['Hover', 'Data', 'Document'] },
      { title:'סוללה כגבול', body:'המשימה מתוכננת לפי היכולת לחזור.', bullets:['Battery', 'Back', 'Land'] }
    ]
  });

  Object.assign(window.TELLO_MISSION_LAB_LESSONS[6], {
    title: 'שיעור 7: Grid Scan ראשון — מכסים שטח כמו חוקרים',
    subtitle: 'סריקת גריד שיטתית במקום טיסה אקראית',
    concept: 'Grid Scan, כיסוי שטח, אזורי חיפוש ותיעוד ממצאים',
    story: 'במשימת חיפוש אחרי ציוד שאבד, טיסה אקראית מפספסת אזורים. צוות החקר לומד לחלק את השטח לגריד ולסרוק בצורה מסודרת.',
    mission: 'לבנות Grid Scan בסימולטור, לסמן אילו תאים כוסו, ולבחור תא אחד להרצה פיזית/הדגמה קצרה באישור מדריך.',
    blocks: ['safety_check', 'takeoff', 'grid_scan', 'hover_data', 'land'],
    essentialQuestion: 'איך יודעים שסרקנו את כל השטח ולא רק טסנו “בערך”?',
    successCriteria: ['אני מגדיר/ה מטרת חקר לפני קוד.', 'אני בונה רצף בלוקים שמתאים למטרה.', 'אני מתעד/ת תוצאה או נתון.', 'אני מתייחס/ת לאילוץ בטיחותי.', 'אני מבצע/ת דיבוג של פרמטר אחד.'],
    realWorldUses: [
      { icon:'🧭', title:'חקר שיטתי', text:'תכנון מסודר הופך טיסה למידע שימושי.' },
      { icon:'🛡️', title:'בטיחות משימה', text:'מגדירים גבולות לפני הפעלה.' },
      { icon:'📊', title:'תיעוד נתונים', text:'מה שנמדד ומתועד יכול להפוך למסקנה.' }
    ],
    vocabulary: [
      ['Research Goal','מטרת החקר שהרחפן אמור לשרת.'],
      ['Data','מידע שנאסף במשימה.'],
      ['Constraint','אילוץ כמו סוללה, שטח או זמן.'],
      ['Prototype','גרסה קצרה לבדיקה.'],
      ['Evidence','ראיה/תוצר שמוכיח מה מצאנו.']
    ],
    safetyRules: ['טיסה פיזית רק באישור מדריך ובתור מוגדר.', 'משקפי מגן ואזור סטרילי בכל הפעלה פיזית.', 'כל משימה מתחילה בבדיקת סוללה, מדחפים ומרחב.', 'אם יש סטייה או אדם נכנס לאזור — Abort/Land מיד.', 'שומרים גרסת סימולטור לפני שינוי פיזי.'],
    commonDirections: [['Plan', 'מגדירים מטרה לפני קוד.'], ['Scan', 'מבצעים סריקה מסודרת.'], ['Data', 'עוצרים ומתעדים.'], ['Debug', 'משנים פרמטר אחד.'], ['Share', 'שומרים ומשתפים.']],
    setupSteps: ['פותחים את גרסת השיעור הקודם ובודקים מה נשמר.', 'מריצים קודם בסימולטור.', 'מגדירים תפקידים: Driver, Navigator, Observer/Data Recorder.', 'בודקים אזור וסוללה אם יש הרצה פיזית.', 'שומרים בשם ברור ומשתפים/מצלמים תוצר.'],
    tabletTips: ['לשמור ב־WiFi בית ספרי לפני מעבר ל־Tello WiFi.', 'לא לשנות כמה פרמטרים יחד.', 'לצלם מסך אם Share Link לא זמין.', 'לחזור ל־WiFi בית ספרי אחרי טיסה פיזית לתיעוד.', 'לסגור אפליקציות מיותרות לפני סימולטור.'],
    lessonFlow: [
      { minutes:'0–8', title:'גשר מהשיעור הקודם', teacher:'מחבר את התוצר הקודם לאתגר החדש.', students:'פותחים תיעוד קודם.' },
      { minutes:'8–18', title:'עלילת משימה', teacher:'מציג בעיית חקר וגבולות משימה.', students:'מגדירים מטרה אחת.' },
      { minutes:'18–30', title:'תכנון לפני קוד', teacher:'מדגים מפת מסלול/טבלה קצרה.', students:'משרטטים תוכנית.' },
      { minutes:'30–48', title:'בנייה בסימולטור', teacher:'מדגים רצף בלוקים מרכזי.', students:'בונים ומריצים.' },
      { minutes:'48–64', title:'בדיקה/הרצה מבוקרת', teacher:'מנהל הרצה פיזית קצרה רק אם מתאים.', students:'מריצים או מתעדים סימולטור.' },
      { minutes:'64–76', title:'תיעוד חקר', teacher:'מנחה טבלת תכנון/תוצאה/מסקנה.', students:'ממלאים תיעוד.' },
      { minutes:'76–86', title:'משוב ודיבוג', teacher:'מוביל משוב עמיתים ושינוי אחד.', students:'מתקנים פרמטר אחד.' },
      { minutes:'86–90', title:'סיכום', teacher:'מחבר לשיעור הבא.', students:'כרטיס יציאה.' }
    ],
    exercises: [
      { minutes:'8–18', title:'מטרת חקר', prompt:'כתבו מטרה אחת למשימה.', check:'המטרה ברורה.' },
      { minutes:'18–30', title:'תוכנית לפני קוד', prompt:'שרטטו מסלול/טבלה.', check:'יש תכנון.' },
      { minutes:'30–48', title:'בנייה והרצה', prompt:'בנו את רצף הבלוקים והריצו.', check:'יש Land בסוף.' },
      { minutes:'48–64', title:'בדיקה מבוקרת', prompt:'בדקו תוצאה בסימולטור/פיזי מאושר.', check:'התוצאה מתועדת.' },
      { minutes:'64–76', title:'תיעוד נתונים', prompt:'כתבו מה נאסף ומה המשמעות.', check:'יש נתון ומסקנה.' },
      { minutes:'76–86', title:'שינוי אחד', prompt:'בצעו תיקון אחד בלבד.', check:'התיקון ברור.' },
      { minutes:'86–90', title:'כרטיס יציאה', prompt:'השלימו משפט סיכום.', check:'התשובה קשורה לחקר ובטיחות.' }
    ],
    deliverable: 'שיעור 7: Grid Scan ראשון: תוצר חקר שמור + תיעוד קצר + החלטת דיבוג אחת.',
    assessment: ['המטרה מנוסחת לפני הקוד.', 'הרצף מתאים למשימת החקר.', 'יש תיעוד תוצאה.', 'יש התייחסות לבטיחות/אילוץ.', 'בוצע שינוי אחד בלבד בדיבוג.'],
    debugging: [
      { problem:'אין מטרה ברורה', fix:'עוצרים ומנסחים שאלת חקר אחת.' },
      { problem:'הקוד ארוך מדי', fix:'מצמצמים לגרסת בדיקה קצרה.' },
      { problem:'התיעוד חסר', fix:'דורשים טבלת תכנון/תוצאה/מסקנה.' },
      { problem:'הרצה פיזית לא בטוחה', fix:'עוברים לסימולטור בלבד.' }
    ],
    differentiation: { support: ['לתת תבנית תכנון מוכנה.', 'להפחית מספר נקודות במסלול.', 'לאפשר תיעוד בעל פה/ציור.'], extension: ['להוסיף מדד כמותי.', 'להשוות שתי אסטרטגיות בסימולטור.', 'להציע סיכון ותוכנית גיבוי.'] },
    instructorGuide: { prerequisites: 'נדרש רצף קודם של Mission Lab: סימולטור, טיסה פיזית מבוקרת ותיעוד חקר בסיסי.', pedagogy: ['להקפיד שהאתגר נשאר חקר ולא רק בניית מסלול.', 'לתת ערך לתכנון לפני קוד.', 'לשמור על שינוי אחד בכל דיבוג.'], mediaNote: commonInstructorMediaNote, exitTicket: 'המשימה שלנו הצליחה כחקר כי ___.' },
    videoResources: grade6VideoResources,
    screenshotSlides: [
      { title:'פותחים משימת חקר', src:'assets/tello-mission-lab/lesson7/open-app.png', caption:'מתחילים מגרסת סימולטור ושם משימה ברור.' },
      { title:'רצף בלוקים', src:'assets/tello-mission-lab/lesson7/block-sequence.png', caption:'בודקים שהרצף מתאים למטרת החקר.' },
      { title:'הרצה ובדיקה', src:'assets/tello-mission-lab/lesson7/simulator-run.png', caption:'מריצים, מודדים ומתעדים תוצאה.' },
      { title:'שמירה ושיתוף', src:'assets/tello-mission-lab/lesson7/save-share.png', caption:'שומרים תוצר ותיעוד למדריך.' }
    ],
    instructorSlides: [
      { title:'משימת חקר', body:'מטרה, גבולות ותוצר לפני קוד.', bullets:['Goal', 'Data', 'Safety'] },
      { title:'בונים ובודקים', body:'סימולטור לפני פיזי ושינוי אחד בדיבוג.', bullets:['Simulate', 'Test', 'Debug'] },
      { title:'תיעוד', body:'נתון בלי תיעוד אינו ממצא.', bullets:['Record', 'Explain', 'Share'] }
    ]
  });

  Object.assign(window.TELLO_MISSION_LAB_LESSONS[7], {
    title: 'שיעור 8: צילום ראיות — מצלמה ככלי נתונים',
    subtitle: 'שילוב Take Photo, גובה תצפית והשוואת איכות מידע',
    concept: 'צילום נקודת עניין, גובה תצפית, איכות נתונים ותיעוד חזותי',
    story: 'רחפן חקר לא רק טס — הוא אוסף ראיות. הצוות מתכנן הגעה לנקודה, ריחוף, צילום ותיעוד מה התמונה אמורה להוכיח.',
    mission: 'לבנות משימה עם Take Photo בנקודת עניין, להשוות צילום מגובה/מרחק שונה, ולשמור תיעוד ראיות.',
    blocks: ['safety_check', 'takeoff', 'forward', 'hover', 'photo', 'land'],
    essentialQuestion: 'איך תמונה הופכת לנתון חקר ולא רק “צילום יפה”?',
    successCriteria: ['אני מגדיר/ה מטרת חקר לפני קוד.', 'אני בונה רצף בלוקים שמתאים למטרה.', 'אני מתעד/ת תוצאה או נתון.', 'אני מתייחס/ת לאילוץ בטיחותי.', 'אני מבצע/ת דיבוג של פרמטר אחד.'],
    realWorldUses: [
      { icon:'🧭', title:'חקר שיטתי', text:'תכנון מסודר הופך טיסה למידע שימושי.' },
      { icon:'🛡️', title:'בטיחות משימה', text:'מגדירים גבולות לפני הפעלה.' },
    ...
    deliverable: 'שיעור 8: צילום ראיות: תוצר חקר שמור + תיעוד קצר + החלטת דיבוג אחת.',
    assessment: ['המטרה מנוסחת לפני הקוד.', 'הרצף מתאים למשימת החקר.', 'יש תיעוד תוצאה.', 'יש התייחסות לבטיחות/אילוץ.', 'בוצע שינוי אחד בלבד בדיבוג.'],
    debugging: [
      { problem:'אין מטרה ברורה', fix:'עוצרים ומנסחים שאלת חקר אחת.' },
      { problem:'הקוד ארוך מדי', fix:'מצמצמים לגרסת בדיקה קצרה.' },
    ...
    videoResources: grade6VideoResources,
    screenshotSlides: [
      { title:'פותחים משימת חקר', src:'assets/tello-mission-lab/lesson8/open-app.png', caption:'מתחילים מגרסת סימולטור ושם משימה ברור.' },
      { title:'רצף בלוקים', src:'assets/tello-mission-lab/lesson8/block-sequence.png', caption:'בודקים שהרצף מתאים למטרת החקר.' },
      { title:'הרצה ובדיקה', src:'assets/tello-mission-lab/lesson8/simulator-run.png', caption:'מריצים, מודדים ומתעדים תוצאה.' },
      { title:'שמירה ושיתוף', src:'assets/tello-mission-lab/lesson8/save-share.png', caption:'שומרים תוצר ותיעוד למדריך.' }
    ],
    instructorSlides: [
      { title:'משימת חקר', body:'מטרה, גבולות ותוצר לפני קוד.', bullets:['Goal', 'Data', 'Safety'] },
      { title:'בונים ובודקים', body:'סימולטור לפני פיזי ושינוי אחד בדיבוג.', bullets:['Simulate', 'Test', 'Debug'] },
  ...
  Object.assign(window.TELLO_MISSION_LAB_LESSONS[8], {
    ...
    subtitle: 'Fallback, Abort וקבלת החלטות בזמן משימה',
    concept: 'אילוצים, תוכנית גיבוי, קיצור מסלול ו־Abort בטוח',
    story: 'באמצע משימת חקר מתברר שהסוללה נמוכה והמטרה הוזזה. מהנדסים צעירים לא מאלתרים — הם מפעילים תוכנית גיבוי בטוחה.',
    mission: 'לקבל כרטיס אילוץ, לקצר/לשנות את המשימה בפרמטר אחד, ולהחליט מתי Abort/Land הוא הפתרון המקצועי.',
    blocks: ['safety_check', 'takeoff', 'repeat_scan', 'hover_data', 'abort', 'land'],
    essentialQuestion: 'איך משנים משימה בלי לאבד בטיחות ובלי למחוק את מטרת החקר?',
    successCriteria: ['אני מגדיר/ה מטרת חקר לפני קוד.', 'אני בונה רצף בלוקים שמתאים למטרה.', 'אני מתעד/ת תוצאה או נתון.', 'אני מתייחס/ת לאילוץ בטיחותי.', 'אני מבצע/ת דיבוג של פרמטר אחד.'],
    realWorldUses: [
      { icon:'🧭', title:'חקר שיטתי', text:'תכנון מסודר הופך טיסה למידע שימושי.' },
      { icon:'🛡️', title:'בטיחות משימה', text:'מגדירים גבולות לפני הפעלה.' },
    ...
    deliverable: 'שיעור 9: אילוצים דינמיים: תוצר חקר שמור + תיעוד קצר + החלטת דיבוג אחת.',
    assessment: ['המטרה מנוסחת לפני הקוד.', 'הרצף מתאים למשימת החקר.', 'יש תיעוד תוצאה.', 'יש התייחסות לבטיחות/אילוץ.', 'בוצע שינוי אחד בלבד בדיבוג.'],
    debugging: [
      { problem:'אין מטרה ברורה', fix:'עוצרים ומנסחים שאלת חקר אחת.' },
      { problem:'הקוד ארוך מדי', fix:'מצמצמים לגרסת בדיקה קצרה.' },
    ...
    videoResources: grade6VideoResources,
    screenshotSlides: [
      { title:'פותחים משימת חקר', src:'assets/tello-mission-lab/lesson9/open-app.png', caption:'מתחילים מגרסת סימולטור ושם משימה ברור.' },
      { title:'רצף בלוקים', src:'assets/tello-mission-lab/lesson9/block-sequence.png', caption:'בודקים שהרצף מתאים למטרת החקר.' },
      { title:'הרצה ובדיקה', src:'assets/tello-mission-lab/lesson9/simulator-run.png', caption:'מריצים, מודדים ומתעדים תוצאה.' },
      { title:'שמירה ושיתוף', src:'assets/tello-mission-lab/lesson9/save-share.png', caption:'שומרים תוצר ותיעוד למדריך.' }
    ],
    instructorSlides: [
      { title:'משימת חקר', body:'מטרה, גבולות ותוצר לפני קוד.', bullets:['Goal', 'Data', 'Safety'] },
      { title:'בונים ובודקים', body:'סימולטור לפני פיזי ושינוי אחד בדיבוג.', bullets:['Simulate', 'Test', 'Debug'] },
  ...
  Object.assign(window.TELLO_MISSION_LAB_LESSONS[9], {
    ...
    subtitle: 'מבעיה אמיתית לתוכנית משימת רחפן',
    concept: 'Project Blueprint, מטרות חקר, תוצרים, סיכונים וגרסת אב־טיפוס',
    story: 'הצוותים בוחרים בעיית חקר: שריפה, קווי מתח, חממה, חוף או מאדים. לפני קוד מלא, הם מגדירים מטרות, נתונים, סיכונים וגרסת סימולטור ראשונה.',
    mission: 'לבנות Blueprint לפרויקט חקר: בעיה, מטרות, מסלול, נתונים שייאספו, סיכונים, ו־Prototype קצר בסימולטור.',
    blocks: ['comment', 'takeoff', 'grid_scan', 'photo', 'land', 'share'],
    essentialQuestion: 'איך מתכננים פרויקט רחפן לפני שנכנסים לקוד מלא?',
    successCriteria: ['אני מגדיר/ה מטרת חקר לפני קוד.', 'אני בונה רצף בלוקים שמתאים למטרה.', 'אני מתעד/ת תוצאה או נתון.', 'אני מתייחס/ת לאילוץ בטיחותי.', 'אני מבצע/ת דיבוג של פרמטר אחד.'],
    realWorldUses: [
      { icon:'🧭', title:'חקר שיטתי', text:'תכנון מסודר הופך טיסה למידע שימושי.' },
      { icon:'🛡️', title:'בטיחות משימה', text:'מגדירים גבולות לפני הפעלה.' },
    ...
    deliverable: 'שיעור 10: Blueprint: תוצר חקר שמור + תיעוד קצר + החלטת דיבוג אחת.',
    assessment: ['המטרה מנוסחת לפני הקוד.', 'הרצף מתאים למשימת החקר.', 'יש תיעוד תוצאה.', 'יש התייחסות לבטיחות/אילוץ.', 'בוצע שינוי אחד בלבד בדיבוג.'],
    debugging: [
      { problem:'אין מטרה ברורה', fix:'עוצרים ומנסחים שאלת חקר אחת.' },
      { problem:'הקוד ארוך מדי', fix:'מצמצמים לגרסת בדיקה קצרה.' },
    ...
    videoResources: grade6VideoResources,
    screenshotSlides: [
      { title:'פותחים משימת חקר', src:'assets/tello-mission-lab/lesson10/open-app.png', caption:'מתחילים מגרסת סימולטור ושם משימה ברור.' },
      { title:'רצף בלוקים', src:'assets/tello-mission-lab/lesson10/block-sequence.png', caption:'בודקים שהרצף מתאים למטרת החקר.' },
      { title:'הרצה ובדיקה', src:'assets/tello-mission-lab/lesson10/simulator-run.png', caption:'מריצים, מודדים ומתעדים תוצאה.' },
      { title:'שמירה ושיתוף', src:'assets/tello-mission-lab/lesson10/save-share.png', caption:'שומרים תוצר ותיעוד למדריך.' }
    ],
    instructorSlides: [
      { title:'משימת חקר', body:'מטרה, גבולות ותוצר לפני קוד.', bullets:['Goal', 'Data', 'Safety'] },
      { title:'בונים ובודקים', body:'סימולטור לפני פיזי ושינוי אחד בדיבוג.', bullets:['Simulate', 'Test', 'Debug'] },
  ...
  // HYBRID_MODEL_GRADE6_LESSONS_6_10_END

  // HYBRID_MODEL_GRADE6_LESSONS_11_15_START

  Object.assign(window.TELLO_MISSION_LAB_LESSONS[10], {
    title:'שיעור 11: מעבדת פיתוח — בונים גרסת V1 לפרויקט החקר', subtitle:'מ־Blueprint לגרסה ראשונה קצרה ובדיקה בסימולטור', concept:'V1 Prototype, Scope, בניית מסלול חקר ותיעוד גרסה', story:'אחרי Blueprint, צוותי Mission Lab בונים גרסה קטנה של הפרויקט. המטרה היא לא להשלים הכול, אלא להוכיח שהרעיון המרכזי עובד.', mission:'לבנות Project_V1: Comment → Takeoff → Grid/Route קצר → Photo/Hover Data → Land, לשמור ולתעד מה חסר.', blocks:['comment', 'takeoff', 'grid_scan', 'photo', 'land'],
    essentialQuestion:'איך הופכים Blueprint לגרסה ראשונה שאפשר לבדוק?',
    successCriteria:['אני מגדיר/ה יעד עבודה ברור.', 'אני בונה גרסה קטנה שניתנת לבדיקה.', 'אני מתעד/ת תוצאה או ראיה.', 'אני מבצע/ת דיבוג עם שינוי אחד.', 'אני מסביר/ה את ההחלטות של הצוות.'],
    realWorldUses:[
      { icon:'🧪', title:'פרויקט חקר', text:'תהליך הנדסי מתקדם בגרסאות ובבדיקות.' },
      { icon:'📊', title:'איכות נתונים', text:'תוצר טוב כולל ממצא, לא רק טיסה.' },
      { icon:'🎤', title:'הצגה מקצועית', text:'חוקרים צריכים להסביר בחירות ודיבוג.' }
    ],
    vocabulary:[
      ['Iteration','גרסת שיפור אחת בתהליך.'],
      ['Evidence','ראיה/נתון שמחזק מסקנה.'],
      ['Reliability','אמינות בין הרצות.'],
      ['Submission','חבילת הגשה מסודרת.'],
      ['Reflection','מה למדתי ומה אשפר בהמשך.']
    ],
    safetyRules:['טיסה פיזית רק אם הגרסה עברה סימולטור ואישור מדריך.', 'אזור סטרילי ומשקפי מגן בכל הרצה פיזית.', 'אם יש ספק — מציגים בסימולטור במקום לאלתר.', 'לא משנים קוד בזמן רחפן באוויר.', 'כל הדגמה מסתיימת ב־Land או סימולטור גיבוי.'],
    commonDirections:[['Goal', 'מטרת חקר.'], ['Prototype', 'גרסה לבדיקה.'], ['Test', 'הרצת בדיקה.'], ['Debug', 'תיקון אחד.'], ['Share', 'שיתוף/הצגה.']],
    setupSteps:['פותחים את גרסת הפרויקט/Blueprint.', 'בודקים מה היעד של השיעור.', 'מריצים בסימולטור לפני פיזי.', 'מתעדים תוצאה ודיבוג.', 'שומרים ומשתפים גרסה בשם ברור.'],
    tabletTips:['לשמור עותק לפני שינוי גדול.', 'לצלם מסך של קוד ותוצאה.', 'Share Link רק ב־WiFi בית ספרי.', 'להכין גרסת גיבוי בסימולטור.', 'לא לערוך בזמן הצגה.'],
    lessonFlow:[
      { minutes:'0–8', title:'בדיקת תנאי קדם', teacher:'בודק תוצרים מהשיעור הקודם ומגדיר יעד שיעור.', students:'פותחים גרסה/Blueprint.' },
      { minutes:'8–18', title:'מיקוד משימת חקר', teacher:'מחדד בעיה, נתון נדרש וסיכון.', students:'מנסחים יעד עבודה.' },
      { minutes:'18–30', title:'תכנון גרסה', teacher:'מראה איך מצמצמים לגרסה שניתנת לבדיקה.', students:'בוחרים Scope קטן.' },
      { minutes:'30–50', title:'בנייה בסימולטור', teacher:'מלווה בניית קוד/תוצר מרכזי.', students:'בונים ומריצים.' },
      { minutes:'50–66', title:'בדיקה מבוקרת', teacher:'מאשר פיזי חלקי רק אם בטוח.', students:'בודקים ומתעדים.' },
      { minutes:'66–78', title:'דיבוג ותיעוד', teacher:'דורש שינוי אחד והסבר סיבה.', students:'מתקנים ומתעדים.' },
      { minutes:'78–86', title:'משוב עמיתים', teacher:'מוביל משוב לפי רובריקה קצרה.', students:'נותנים/מקבלים משוב.' },
      { minutes:'86–90', title:'סיכום', teacher:'מחבר לשלב הבא בפרויקט.', students:'כרטיס יציאה.' }
    ],
    exercises:[
      { minutes:'8–18', title:'יעד שיעור', prompt:'כתבו מה חייב להתקדם היום.', check:'היעד ספציפי.' },
      { minutes:'18–30', title:'Scope קטן', prompt:'בחרו חלק אחד לבדיקה.', check:'לא בונים הכול יחד.' },
      { minutes:'30–50', title:'בנייה והרצה', prompt:'בנו והריצו בסימולטור.', check:'יש Land/סיום בטוח.' },
      { minutes:'50–66', title:'בדיקה', prompt:'בדקו תוצאה ותעדו.', check:'יש תוצאה כתובה.' },
      { minutes:'66–78', title:'דיבוג', prompt:'שנו פרמטר אחד והסבירו למה.', check:'השינוי מתועד.' },
      { minutes:'78–86', title:'משוב', prompt:'קבלו שאלה אחת מצוות אחר.', check:'יש שיפור/תשובה.' },
      { minutes:'86–90', title:'כרטיס יציאה', prompt:'השלימו משפט סיכום.', check:'התשובה מחברת חקר, קוד ובטיחות.' }
    ],
    deliverable:'מעבדת פיתוח — בונים גרסת V1 לפרויקט החקר — תוצר פרויקט שמור ומתועד.',
    assessment:['יש מטרה ותוצר מוגדרים.', 'הקוד/המסלול תואם למטרת החקר.', 'יש תיעוד תוצאה או ראיה.', 'הדיבוג מבוסס שינוי אחד.', 'הצוות שומר על בטיחות והסבר מקצועי.'],
    debugging:[
      { problem:'הצוות בונה יותר מדי', fix:'מצמצמים ל־V1/חלק אחד.' },
      { problem:'אין תיעוד נתונים', fix:'עוצרים וממלאים טבלת תוצאה.' },
      { problem:'הטיסה לא יציבה', fix:'מציגים סימולטור/תהליך במקום לאלתר פיזית.' },
      { problem:'ההסבר לא ברור', fix:'מחזירים למבנה: מטרה, קוד, נתון, דיבוג.' }
    ],
    differentiation:{ support:['לתת תבנית תיעוד מוכנה.', 'לאפשר סימולטור בלבד.', 'להציג בעל פה במקום כתיבה מלאה.'], extension:['להוסיף מדד כמותי.', 'להכין גרסת גיבוי.', 'להוביל משוב עמיתים או רפלקציה.'] },
    instructorGuide:{ prerequisites:'נדרש Blueprint/גרסת פרויקט מהשלבים הקודמים. אם אין גרסה יציבה, עובדים בסימולטור ומצמצמים Scope.', pedagogy:['שלב הפרויקט חייב להיות מנוהל — לא “זמן חופשי”.', 'להעריך תהליך חקר: תכנון, נתונים, דיבוג והסבר.', 'בטיחות והחלטה לא להטיס הן חלק מהנדסה מקצועית.'], mediaNote:commonInstructorMediaNote, exitTicket:'הפרויקט שלנו התקדם כי ___.' },
    videoResources:grade6VideoResources,
    screenshotSlides:[
      { title:'פותחים גרסת פרויקט', src:'assets/tello-mission-lab/lesson11/open-app.png', caption:'מתחילים מהתכנון/גרסה הקודמת.' },
      { title:'רצף פרויקט', src:'assets/tello-mission-lab/lesson11/block-sequence.png', caption:'בודקים שהקוד משרת את מטרת החקר.' },
      { title:'בדיקה והרצה', src:'assets/tello-mission-lab/lesson11/simulator-run.png', caption:'מריצים, מודדים ומתעדים.' },
      { title:'שיתוף תוצר', src:'assets/tello-mission-lab/lesson11/save-share.png', caption:'שומרים גרסה, קישור ותיעוד.' }
    ],
    instructorSlides:[
      { title:'שלב פרויקט', body:'עובדים בגרסאות קטנות ובדיקות.', bullets:['Goal', 'Prototype', 'Test'] },
      { title:'נתונים ודיבוג', body:'ממצא טוב דורש תיעוד ושינוי אחד.', bullets:['Evidence', 'Debug', 'Improve'] },
      { title:'הצגה בטוחה', body:'מסבירים החלטות ולא מאלתרים.', bullets:['Pitch', 'Demo', 'Reflection'] }
    ]
  });

  Object.assign(window.TELLO_MISSION_LAB_LESSONS[11], {
    title:'שיעור 12: בדיקות שטח — נתונים, סטייה ותיקון', subtitle:'בדיקות V1, מדידת סטייה ושיפור V2', concept:'Field Test, Data Log, Drift, V2', story:'גרסת V1 יוצאת לבדיקת שטח מבוקרת. הצוותים מודדים מה באמת קרה ומשנים פרמטר אחד בלבד.', mission:'להריץ V1, למלא Data/Debug Log, לבחור תיקון אחד ולשמור Project_V2.', blocks:['safety_check', 'takeoff', 'project_path', 'hover_data', 'land'],
    essentialQuestion:'איך מודדים ומתקנים פרויקט חקר בלי לנחש?',
    successCriteria:['אני מגדיר/ה יעד עבודה ברור.', 'אני בונה גרסה קטנה שניתנת לבדיקה.', 'אני מתעד/ת תוצאה או ראיה.', 'אני מבצע/ת דיבוג עם שינוי אחד.', 'אני מסביר/ה את ההחלטות של הצוות.'],
    realWorldUses:[
      { icon:'🧪', title:'פרויקט חקר', text:'תהליך הנדסי מתקדם בגרסאות ובבדיקות.' },
      { icon:'📊', title:'איכות נתונים', text:'תוצר טוב כולל ממצא, לא רק טיסה.' },
    ...
    deliverable:'בדיקות שטח — נתונים, סטייה ותיקון — תוצר פרויקט שמור ומתועד.',
    assessment:['יש מטרה ותוצר מוגדרים.', 'הקוד/המסלול תואם למטרת החקר.', 'יש תיעוד תוצאה או ראיה.', 'הדיבוג מבוסס שינוי אחד.', 'הצוות שומר על בטיחות והסבר מקצועי.'],
    debugging:[
      { problem:'הצוות בונה יותר מדי', fix:'מצמצמים ל־V1/חלק אחד.' },
      { problem:'אין תיעוד נתונים', fix:'עוצרים וממלאים טבלת תוצאה.' },
    ...
    videoResources:grade6VideoResources,
    screenshotSlides:[
      { title:'פותחים גרסת פרויקט', src:'assets/tello-mission-lab/lesson12/open-app.png', caption:'מתחילים מהתכנון/גרסה הקודמת.' },
      { title:'רצף פרויקט', src:'assets/tello-mission-lab/lesson12/block-sequence.png', caption:'בודקים שהקוד משרת את מטרת החקר.' },
      { title:'בדיקה והרצה', src:'assets/tello-mission-lab/lesson12/simulator-run.png', caption:'מריצים, מודדים ומתעדים.' },
      { title:'שיתוף תוצר', src:'assets/tello-mission-lab/lesson12/save-share.png', caption:'שומרים גרסה, קישור ותיעוד.' }
    ],
    instructorSlides:[
      { title:'שלב פרויקט', body:'עובדים בגרסאות קטנות ובדיקות.', bullets:['Goal', 'Prototype', 'Test'] },
      { title:'נתונים ודיבוג', body:'ממצא טוב דורש תיעוד ושינוי אחד.', bullets:['Evidence', 'Debug', 'Improve'] },
  ...
  Object.assign(window.TELLO_MISSION_LAB_LESSONS[12], {
    title:'שיעור 13: אמינות נתונים — חזרות והשוואת הרצות', subtitle:'בדיקות חוזרות, עקביות וגרסת Release Candidate', concept:'Reliability, Consistency, Test Runs, RC', story:'פרויקט שעבד פעם אחת עוד לא מוכיח ממצא. הצוותים בודקים עקביות בין הרצות ומחליטים אם המידע אמין להצגה.', mission:'לבצע 2–3 הרצות, להשוות תוצאות, לבצע Final Fix אחד ולשמור Project_RC.', blocks:['safety_check', 'takeoff', 'project_path', 'hover_data', 'photo', 'land'],
    essentialQuestion:'מתי נתון שאספנו מספיק אמין להצגה?',
    successCriteria:['אני מגדיר/ה יעד עבודה ברור.', 'אני בונה גרסה קטנה שניתנת לבדיקה.', 'אני מתעד/ת תוצאה או ראיה.', 'אני מבצע/ת דיבוג עם שינוי אחד.', 'אני מסביר/ה את ההחלטות של הצוות.'],
    realWorldUses:[
      { icon:'🧪', title:'פרויקט חקר', text:'תהליך הנדסי מתקדם בגרסאות ובבדיקות.' },
      { icon:'📊', title:'איכות נתונים', text:'תוצר טוב כולל ממצא, לא רק טיסה.' },
    ...
    deliverable:'אמינות נתונים — חזרות והשוואת הרצות — תוצר פרויקט שמור ומתועד.',
    assessment:['יש מטרה ותוצר מוגדרים.', 'הקוד/המסלול תואם למטרת החקר.', 'יש תיעוד תוצאה או ראיה.', 'הדיבוג מבוסס שינוי אחד.', 'הצוות שומר על בטיחות והסבר מקצועי.'],
    debugging:[
      { problem:'הצוות בונה יותר מדי', fix:'מצמצמים ל־V1/חלק אחד.' },
      { problem:'אין תיעוד נתונים', fix:'עוצרים וממלאים טבלת תוצאה.' },
    ...
    videoResources:grade6VideoResources,
    screenshotSlides:[
      { title:'פותחים גרסת פרויקט', src:'assets/tello-mission-lab/lesson13/open-app.png', caption:'מתחילים מהתכנון/גרסה הקודמת.' },
      { title:'רצף פרויקט', src:'assets/tello-mission-lab/lesson13/block-sequence.png', caption:'בודקים שהקוד משרת את מטרת החקר.' },
      { title:'בדיקה והרצה', src:'assets/tello-mission-lab/lesson13/simulator-run.png', caption:'מריצים, מודדים ומתעדים.' },
      { title:'שיתוף תוצר', src:'assets/tello-mission-lab/lesson13/save-share.png', caption:'שומרים גרסה, קישור ותיעוד.' }
    ],
    instructorSlides:[
      { title:'שלב פרויקט', body:'עובדים בגרסאות קטנות ובדיקות.', bullets:['Goal', 'Prototype', 'Test'] },
      { title:'נתונים ודיבוג', body:'ממצא טוב דורש תיעוד ושינוי אחד.', bullets:['Evidence', 'Debug', 'Improve'] },
  ...
  Object.assign(window.TELLO_MISSION_LAB_LESSONS[13], {
    title:'שיעור 14: חבילת הגשה — קוד, נתונים והסבר חוקר', subtitle:'Share Link, תיעוד, רובריקה ותסריט הצגה', concept:'Submission Package, Share, Rubric, Research Pitch', story:'הפרויקט כמעט מוכן. עכשיו צריך להפוך אותו לתוצר שאפשר לבדוק: קישור, קוד מסודר, נתונים, הסבר ודיבוג.', mission:'להכין חבילת הגשה: Project_Final, Share Link/צילום, Data Log, רובריקה ותסריט הצגה של 90 שניות.', blocks:['comment', 'takeoff', 'project_path', 'photo', 'land', 'share'],
    essentialQuestion:'איך מציגים פרויקט חקר כך שאפשר להבין את הבעיה, הנתונים והפתרון?',
    successCriteria:['אני מגדיר/ה יעד עבודה ברור.', 'אני בונה גרסה קטנה שניתנת לבדיקה.', 'אני מתעד/ת תוצאה או ראיה.', 'אני מבצע/ת דיבוג עם שינוי אחד.', 'אני מסביר/ה את ההחלטות של הצוות.'],
    realWorldUses:[
      { icon:'🧪', title:'פרויקט חקר', text:'תהליך הנדסי מתקדם בגרסאות ובבדיקות.' },
      { icon:'📊', title:'איכות נתונים', text:'תוצר טוב כולל ממצא, לא רק טיסה.' },
    ...
    deliverable:'חבילת הגשה — קוד, נתונים והסבר חוקר — תוצר פרויקט שמור ומתועד.',
    assessment:['יש מטרה ותוצר מוגדרים.', 'הקוד/המסלול תואם למטרת החקר.', 'יש תיעוד תוצאה או ראיה.', 'הדיבוג מבוסס שינוי אחד.', 'הצוות שומר על בטיחות והסבר מקצועי.'],
    debugging:[
      { problem:'הצוות בונה יותר מדי', fix:'מצמצמים ל־V1/חלק אחד.' },
      { problem:'אין תיעוד נתונים', fix:'עוצרים וממלאים טבלת תוצאה.' },
    ...
    videoResources:grade6VideoResources,
    screenshotSlides:[
      { title:'פותחים גרסת פרויקט', src:'assets/tello-mission-lab/lesson14/open-app.png', caption:'מתחילים מהתכנון/גרסה הקודמת.' },
      { title:'רצף פרויקט', src:'assets/tello-mission-lab/lesson14/block-sequence.png', caption:'בודקים שהקוד משרת את מטרת החקר.' },
      { title:'בדיקה והרצה', src:'assets/tello-mission-lab/lesson14/simulator-run.png', caption:'מריצים, מודדים ומתעדים.' },
      { title:'שיתוף תוצר', src:'assets/tello-mission-lab/lesson14/save-share.png', caption:'שומרים גרסה, קישור ותיעוד.' }
    ],
    instructorSlides:[
      { title:'שלב פרויקט', body:'עובדים בגרסאות קטנות ובדיקות.', bullets:['Goal', 'Prototype', 'Test'] },
      { title:'נתונים ודיבוג', body:'ממצא טוב דורש תיעוד ושינוי אחד.', bullets:['Evidence', 'Debug', 'Improve'] },
  ...
  Object.assign(window.TELLO_MISSION_LAB_LESSONS[14], {
    title:'שיעור 15: Mission Lab Expo — מציגים משימת חקר רחפן', subtitle:'אירוע שיא, הדגמה בטוחה, משוב ורפלקציה', concept:'Showcase, Demo, Peer Feedback, Reflection', story:'יום התערוכה הגיע. כל צוות מציג בעיית חקר, תוכנית טיסה, נתון שנאסף, באג שפתר, והחלטת בטיחות אחת.', mission:'להציג פרויקט מסכם: Pitch, הדגמת סימולטור/פיזית באישור, משוב עמיתים ורפלקציה אישית.', blocks:['safety_check', 'takeoff', 'project_path', 'photo', 'land'],
    ...
    deliverable:'Mission Lab Expo — מציגים משימת חקר רחפן — תוצר פרויקט שמור ומתועד.',
    assessment:['יש מטרה ותוצר מוגדרים.', 'הקוד/המסלול תואם למטרת החקר.', 'יש תיעוד תוצאה או ראיה.', 'הדיבוג מבוסס שינוי אחד.', 'הצוות שומר על בטיחות והסבר מקצועי.'],
    debugging:[
      { problem:'הצוות בונה יותר מדי', fix:'מצמצמים ל־V1/חלק אחד.' },
      { problem:'אין תיעוד נתונים', fix:'עוצרים וממלאים טבלת תוצאה.' },
    ...
    videoResources:grade6VideoResources,
    screenshotSlides:[
      { title:'פותחים גרסת פרויקט', src:'assets/tello-mission-lab/lesson15/open-app.png', caption:'מתחילים מהתכנון/גרסה הקודמת.' },
      { title:'רצף פרויקט', src:'assets/tello-mission-lab/lesson15/block-sequence.png', caption:'בודקים שהקוד משרת את מטרת החקר.' },
      { title:'בדיקה והרצה', src:'assets/tello-mission-lab/lesson15/simulator-run.png', caption:'מריצים, מודדים ומתעדים.' },
      { title:'שיתוף תוצר', src:'assets/tello-mission-lab/lesson15/save-share.png', caption:'שומרים גרסה, קישור ותיעוד.' }
    ],
    instructorSlides:[
      { title:'שלב פרויקט', body:'עובדים בגרסאות קטנות ובדיקות.', bullets:['Goal', 'Prototype', 'Test'] },
      { title:'נתונים ודיבוג', body:'ממצא טוב דורש תיעוד ושינוי אחד.', bullets:['Evidence', 'Debug', 'Improve'] },
  ...
  // HYBRID_MODEL_GRADE6_LESSONS_11_15_END
