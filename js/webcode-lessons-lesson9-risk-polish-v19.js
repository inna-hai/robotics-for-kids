(function () {
  const lessons = [
    {
      ...
      durationMinutes: 90,
      story: 'פותחים מעבדת WebCode בצורה מוכרת ממסלולי הבלוקים: קודם לוחצים על בלוקי Web שבונים כרטיס אישי, אחר כך רואים איזה HTML/CSS/JavaScript נוצר מאחורי הקלעים.' ,
      ...
      lessonFlow: [
        { minutes: '0–8', title: 'פתיחה: מבלוקים לאתר', teacher: 'מזכירים עבודה עם Blockly ומציגים את הרעיון החדש: בלוק Web בונה חלק באתר.', students: 'מזהים שהכרטיס מורכב מכותרת, משפט, צבע, כפתור והודעה.' },
      ...
      aiHelper: [
        ...
        'הסבירו בשפה פשוטה למה הכפתור לא עובד אם ה־id לא תואם.',
    ...
    },
    {
      ...
      aiHelper: [
        ...
        'הסבירו לילד/ה מה ההבדל בין class לבין id.',
    ...
    },
    {
      ...
      aiHelper: [
        'הסבירו לילד/ה מה הקשר בין onclick לבין function.',
    ...
    },
    {
      ...
      aiHelper: [
        'הציעו 5 רעיונות למחוללים מצחיקים שמתאימים לקבוצה.',
    ...
    },
    {
      ...
      aiHelper: [
        'הציעו 5 שאלות כן/לא פשוטות לקבוצה בנושא מחשבים.',
    ...
    },
    {
      ...
      aiHelper: [
        'הסבירו לילד/ה מה זה משתנה בעזרת דוגמה של קופת נקודות.',
    ...
    },
    {
      ...
      aiHelper: [
        'הציעו 5 נושאים למשחק קליקים פשוט לקבוצה.',
    ...
    },
    {
      ...
      aiHelper: [
        'הסבירו לילד/ה מה זה טיימר בעזרת דוגמה של שעון חול.',
    ...
    },
    {
      ...
      aiHelper: [
        'הסבירו לילד/ה מה ההבדל בין ניקוד לבין חיים במשחק.',
    ...
    },
    {
      ...
      aiHelper: [
        'הציעו שם למשחק כוכבים של תלמיד/ה.',
  ...
  Object.assign(lessons[0], {
    ...
    exercises: [
      ...
      { id: 7, minutes: '64–74', title: 'תרגיל 7 — סדר בלי להזיז חתימה', prompt: 'ודאו שבלוק החתימה נמצא בסוף השרשרת. כדי לתרגל שינוי סדר, הזיזו את בלוק “שתי קוביות מידע” למקום אחר מעל החתימה ולחצו בדיקה.', hint: 'החתימה נשארת בסוף. את קוביות המידע אפשר לשים לפני או אחרי הכפתור — כך רואים שסדר הבלוקים משנה את סדר העמוד.', check: { htmlIncludes: ['<footer>', 'class="columns"'], blockTypes: ['web_footer', 'web_columns'], nonEmptyBlocklyFields: [{ type: 'web_footer', field: 'TEXT' }], columnsMovedWithFooterLast: true, blockFeedback: 'כמעט. צריך גם בלוק חתימה וגם בלוק “שתי קוביות מידע”.', emptyFeedback: 'כמעט. החתימה לא יכולה להיות ריקה.', firstCheckFeedback: 'מעולה, החתימה בסוף וקוביות המידע מחוברות. עכשיו הזיזו רק את בלוק “שתי קוביות מידע” למקום אחר מעל החתימה ולחצו בדיקה שוב.', columnsMoveFeedback: 'כמעט. החתימה צריכה להישאר בסוף, ואת בלוק “שתי קוביות מידע” צריך להזיז למקום אחר מעליה.' } },
    ...
    aiHelper: [
      'הציעו 5 רעיונות לעמוד אישי שתלמיד/ה יכול/ה לבנות בבלוקים.',
