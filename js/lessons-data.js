  ...
  const lessons = [
    {
      ...
      sixtyMinuteFlow: [
        { minutes: '0–5', title: 'פתיחת סיפור', tasks: ['המורה מציג: הרחוב בעיר חשוך בלילה', 'שואלים: איך פנס יודע מתי להידלק?'] },
        { minutes: '5–12', title: 'ניסוי קצר בכיתה', tasks: ['מסתכלים על אור/חושך בסביבה', 'מדברים על חיישן אור כמו “עין” של רובוט'] },
        { minutes: '12–20', title: 'הדגמת סנסי', tasks: ['פותחים את הסימולטור', 'מפעילים ומכבים את כפתור “אור”', 'רואים איך חיישן האור משתנה'] },
        { minutes: '20–35', title: 'בנייה מודרכת', tasks: ['גוררים “כאשר לוחצים ▶️”', 'מוסיפים “אם חיישן אור = חשוך”', 'מכניסים לתנאי “פנס רחוב — הדלק”', 'מריצים ובודקים שהפנס נדלק בלילה'] },
        { minutes: '35–45', title: 'בדיקה ושיפור', tasks: ['בודקים מה קורה כשמדליקים אור יום', 'מוסיפים בלוק “אמור” עם הודעה כמו “לילה טוב!”', 'משנים ומריצים שוב'] },
        { minutes: '45–55', title: 'אתגר עצמאי', tasks: ['בנו גרסה שבה סנסי אומר משהו אחר ביום ובלילה', 'ציירו או תארו איפה בעיר הייתם שמים פנס כזה'] },
        { minutes: '55–60', title: 'שיתוף וסיכום', tasks: ['שני תלמידים מציגים פתרון', 'מסכמים: חיישן → תנאי → פעולה'] }
      ],
