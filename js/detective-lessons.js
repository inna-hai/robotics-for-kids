window.DETECTIVE_LESSONS = [
  {
    ...
    clues: [
      { id: 'glitter', text: 'לולי אוהבת נצנצים צהובים', good: true },
      { id: 'water', text: 'דגי אוהב טיפות מים', good: false },
      { id: 'feather', text: 'ציפי אוהבת נוצות כחולות', good: false }
    ],
    rules: [
  ...
  },
  {
    ...
    clues: [
      { id: 'green-card', text: 'יש כרטיס ירוק ליד הדלת', good: true },
    ...
    suspects: ['כרטיס ירוק', 'כרטיס אדום', 'כרטיס כחול']
  },
  {
    id: 3,
    title: 'הרובוט מצפצף',
    ...
    scene: 'הרובוט עומד בחדר ומצפצף שוב ושוב. סיסי רואה סביבו כמה דברים שיכולים להיות קשורים: קיר, ספר פתוח וקור בחדר.',
    concept: 'אם חיישן מרגיש — אז מגיבים',
    learningNote: 'חיישן נותן מידע. הקוד מחליט מה לעשות לפי המידע הזה.',
    clues: [
      { id: 'too-close', text: 'הרובוט כמעט נתקע בקיר', good: true },
