window.CODEQUEST_LESSONS = [
  ...
  },
  {
    id: 2,
    unit: 'יחידה 1 — פקודות ראשונות ותנועה',
    title: 'צעדים חכמים עם משתנה',
    concept: 'משתנה ראשון: step',
    status: 'ready',
    turtleMode: true,
    story: 'הרובוט ממשיך לצייר על אותו דף לבן, אבל הפעם הוא לומד לזכור מספר. במקום לכתוב 70 שוב ושוב, שומרים אותו במשתנה בשם step ומשתמשים בו בכל תנועה.',
    goals: ['להבין שמשתנה הוא שם ששומר ערך', 'להשתמש במשתנה מספרי בתוך forward', 'לראות ששינוי אחד ב־step משנה את כל הציור'],
    challenge: 'צרו משתנה step, תנו לרובוט לצייר ריבוע צבעוני, ואז נסו לשנות רק את המספר של step ולראות איך כל הריבוע משתנה.',
    starterCode: 'step = 70\ncolor("blue")\nforward(step)\nright(90)\ncolor("yellow")\nforward(step)\nright(90)\ncolor("pink")\nforward(step)\nright(90)\ncolor("green")\nforward(step)',
    hints: ['step = 70 שומר את המספר 70 בשם קצר', 'forward(step) משתמש במספר ששמור בתוך step', 'כדי להגדיל את כל הציור משנים רק את השורה הראשונה: step = 90'],
    checks: ['var:step', 'forward', 'right', 'tiles:4', 'colors:2'],
    exercises: [
      'הריצו את הקוד כמו שהוא ותארו איזה מסלול הרובוט צייר.',
      'שנו רק את השורה step = 70 ל־step = 50. מה קרה לכל הצורה?',
      'שנו רק את השורה step = 70 ל־step = 90. למה לא צריך לשנות את כל שורות forward?',
      'החליפו לפחות שני צבעים והשאירו את אותו step.',
      'אתגר: הוסיפו עוד פנייה ועוד forward(step) כדי ליצור צורה אישית.'
    ],
    teacherFlow: ['פתיחת סיפור: הרובוט מקבל זיכרון קטן למספרים.', 'הדגמה: step = 70 ואז forward(step).', 'שינוי קוד מוכן: להחליף רק את הערך של step ולראות שכל הציור משתנה.', 'כתיבה עצמאית: ריבוע או מסלול צבעוני עם אותו step.', 'דיבאג: מה קורה אם מוחקים את השורה step = 70?', 'הצגה: כל תלמיד מסביר איזה מספר בחר ולמה.']
  },
  {
    id: 3,
    unit: 'יחידה 1 — פקודות ראשונות ותנועה',
