window.CODEQUEST_LESSONS = [
  {
    ...
    title: 'הצב הראשון שלי בפייתון',
    concept: 'Turtle: forward, right, color',
    status: 'ready',
    turtleMode: true,
    story: 'הדמות הראשונה שלנו היא צב־קוד. כמו ב־Python Turtle, הצב הולך על דף לבן, מסתובב ומצייר אחריו קווים צבעוניים כמו Turtle אמיתי.',
    goals: ['להכיר פקודות Turtle בסיסיות', 'להבין שכיוון משפיע על forward', 'לראות קוד פייתון כמעט אמיתי שמצייר על המסך'],
    challenge: 'גרמו לצב לצייר על הדף: קו ירוק באורך 80, פנייה ימינה, עוד קו באורך 80, ואז קו צהוב.',
    starterCode: 'color("green")\nforward(80)\nright(90)\nforward(80)\ncolor("yellow")\nforward(80)',
    hints: ['forward(80) מזיז את הצב 80 פיקסלים בכיוון שהוא מסתכל אליו', 'right(90) מסובב את הצב ימינה כמו ב־Turtle', 'color("yellow") משנה את צבע הציור מהנקודה הזאת והלאה'],
    checks: ['color:green', 'forward', 'right', 'color:yellow', 'tiles:3'],
    teacherFlow: ['פתיחת סיפור: הצב מצייר את העולם בקוד.', 'הדגמה: forward לפני ואחרי right.', 'שינוי קוד מוכן: להחליף צבעים ומספר צעדים.', 'כתיבה עצמאית: מסלול של 3–4 צעדים.', 'דיבאג: למה forward הלך לכיוון אחר?', 'הצגה: כל תלמיד מציג את הציור הקטן שלו.']
  },
  {
    id: 2,
    unit: 'יחידה 1 — פקודות ראשונות ותנועה',
  ...
  function codeQuestExercises(lesson) {
    ...
    if (lesson.turtleMode) return [
      'הריצו את הקוד כמו שהוא ותארו מה הצב צייר.',
