...
window.FINALE_CONDITIONS = {
  ...
  fountainLeakAndPeople: { label: 'יש נזילה מהמזרקה ויש אנשים ליד הכיכר', icon: '💧+🚶' },
  fountainLeakNoPeople: { label: 'יש נזילה מהמזרקה אבל אין אנשים ליד הכיכר', icon: '💧+➖' },
  peopleNoFountainLeak: { label: 'יש אנשים ליד הכיכר אבל אין נזילה', icon: '🚶+✅' },
  noLeakNoPeople: { label: 'אין נזילה ואין אנשים ליד הכיכר', icon: '✅+➖' }
};
...
window.FINALE_MISSIONS.push(
  ...
  { id: 12, emoji: '⛲', title: 'המזרקה בכיכר', district: 'כיכר העיר', goal: 'בכיכר העיר יש נזילה מהמזרקה, ואנשים עוברים ליד המקום. סיסי צריכה לעצור את המים ולשמור על האזור בטוח.', condition: 'fountainLeakAndPeople', conditionOptions: ['peopleNoFountainLeak', 'fountainLeakNoPeople', 'fountainLeakAndPeople', 'noLeakNoPeople'], correctActions: ['closeWater','placeWarningSign','markAreaSafe'], actionOptions: ['markAreaSafe','celebrate','closeWater','placeWarningSign'], distractor: 'celebrate', explanation: 'קודם סוגרים את המים, אחר כך מציבים שלט זהירות, ואז מסמנים שהאזור בטוח.', hint: 'רמז: חפשו מצב שבו שני הדברים נכונים. אחר כך חשבו מה עוצר את הבעיה ושומר על אנשים, ומה רק משמח אבל לא פותר את הנזילה.', learningNote: 'סיום הקורס: תנאי נכון, רצף פעולות, והסבר למה הפעולה מתאימה.' }
);
