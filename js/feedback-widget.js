  ...
  function open() {
    ...
    backdrop.innerHTML = `
      <form class="rfw-modal">
        ...
        <div class="rfw-help">המערכת תצרף אוטומטית את העמוד הנוכחי${pageLesson() ? ` ואת שיעור ${pageLesson()}` : ''}.</div>
    ...
    form.addEventListener('submit', async (event) => {
      ...
      try {
        ...
        msg.textContent = 'אופס, לא הצלחנו לשלוח. נסו שוב.';
      } finally {
